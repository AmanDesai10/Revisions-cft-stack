...
import { Post, Organisation } from "@prisma/client";
...
export default function PostCard({
  ...
  data: Post & { organisation: Organisation | null };
}) {
  const url = `${data.organisation?.subdomain}.${process.env.NEXT_PUBLIC_ROOT_DOMAIN}/${data.slug}`;
